...
<div id="wrapper">
	...
	<div id="page-wrapper" class="gray-bg dashbard-1">
		...
		<div class="row content-tabs">
			...
			<nav class="page-tabs J_menuTabs">
				<div class="page-tabs-content">
					...
					<span class=" minimalize-styl-2 btn btn-primary" id="home"  >
						<i class="fa fa-home"></i>
					</span>
					<span class=" minimalize-styl-2 btn btn-primary" id="refresh" >
		...
		<div class="footer">
            <div class="pull-right">Copyright © 2016 - 2018  All Rights Reserved.iThinkphp 版权所有 powered by 
                <a href="http://www.ithinkphp.org/" target="_blank">iThinkphp www.ithinkphp.org</a>
            </div>
        </div>
