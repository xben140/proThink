	...
	*/
	...
	class InitBase
	{
		...
		private function initConfig()
		{
			...
			config('app_debug') ? config('exception_tmpl' , THINK_PATH . 'tpl' . DS . 'think_exception.tpl') : config('exception_tmpl' , ITHINKPHP_COMMON . 'view' . DS . 'think_exception.php');
		}
