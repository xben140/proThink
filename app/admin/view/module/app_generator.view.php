		...
		$__this->displayContents = integrationTags::basicFrame([
			...
			integrationTags::row([
				integrationTags::rowBlock([
					...
					'<p class="red">* 应用ID必填 ID首位必须为小写字母，之后跟数字和字母，会生成 app 目录下的一个模块</p>' ,
					'<p class="red">* 应用ID表示的正则表达式为 ^[a-z][a-z\d]*$ </p>' ,
					...
					'<p class="red">* <strong>如果修改其他内容可能会导致更新 ithinkphp 后出现不可预知的问题，并且应用无法完整打包</strong></p>' ,
					...
					integrationTags::form([
						...
						integrationTags::text([
							'field_name'  => '应用ID' ,
							'placeholder' => '' ,
							'tip'         => '（必填）ID首位必须为小写字母，之后跟数字和字母，会生成 app 目录下的一个模块，如 blog' ,
							//'value'       => 'value' ,
							//'attr'        => 'disabled' ,
							'name'        => 'id' ,
						]) ,
				...
				integrationTags::rowBlock([
					...
					'<p class="red">* 数据表名每行填写一个，不要加 ithinkphp_ 表前缀 </p>' ,
					...
					integrationTags::form([
						...
						integrationTags::textarea([
							'field_name' => '表名' ,
							'tip'        => '需要添加‘增删改查’功能的表名，每行一个，不加 ithinkphp_ 前缀，会自动为这些表生成 controller，model，logic，validate文件' ,
							'name'       => 'tables' ,
							'value'      => '' ,
							'attr'       => '' ,
