	...
	return function($__this) {
		...
		$__this->displayContents = integrationTags::basicFrame([
			integrationTags::form([
				...
				//1:array 2:textarea
				integrationTags::inlineRadio($__this->logic->model_->type , 'type' , '键值类型' , '<span class="red"><br>array,select 键值使用英文冒号分隔，每行一条 <br> textarea 键值没有格式要求，填入字符串即可 <br> switch 键值留空</span>' , $info['type']) ,
