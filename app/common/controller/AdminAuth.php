<?php
	...
	class AdminAuth extends ControllerBase
	{
		//admin信息
		public $adminInfo;
		...
		{
			if(!$this->logic__common_User->model_->isValidateUser($this->adminInfo))
		...
		private function _initAuthClass()
		{
			...
			*/
			...
			//角色
			$roles = $this->logic__common_role->getActivedData(['no_global_admin' => 0 ,]);
