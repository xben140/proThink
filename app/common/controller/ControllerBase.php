<?php
	...
	class ControllerBase extends Controller
	{
		...
		final protected function initTemplateParam()
		{
			...
			$this->view->config([
				'view_path' => PATH_THEMES . strtolower(MODULE_NAME) . DS . config(MODULE_NAME . '_themes') . DS ,
			]);
		...
		public function showPage()
		{
			...
			!is_dir(dirname($tempPath)) && mkdir(dirname($tempPath));
	...
	array(
		...
		'THINK_START_TIME'      => 1531987283.8445001 ,
		...
		'URL_TRUE' => 'http://local15.cc/home/index/index.html?v=4.0' ,
		...
		'__HPLUS__'   => 'http://local15.cc/public/hplus/' ,
		'__ROOT__'    => "" ,
		'__URL__'     => "/home/index" ,
		'__STATIC__'  => "/static/" ,
		'__CSS__'     => "/static/css/" ,
		'__JS__'      => "/static/js/" ,
		'__IMAGE__'   => "http://local15.cc/hplus/" ,
		'__PLUGINS__' => "http://local15.cc/public/plugins/" ,
