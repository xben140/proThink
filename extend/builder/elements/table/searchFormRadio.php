<?php
	...
	class searchFormRadio extends makeBase
	{
		public $path = __DIR__;
...
js;
		...
		{
			$tmp = '<label class="btn  btn-white __CHECKED__"> <input ____CHECKED____ type="radio"   name="__NAME__" value="__VALUE__">__FIELD__</label>';
			$str = '';
