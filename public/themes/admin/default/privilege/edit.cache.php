...
<!-- ! ~~~JS_LIB~~~ -->
	...
	<body   class=" gray-bg" >
		...
		<div class="wrapper wrapper-content animated fadeInRight   ">
			...
			<form action="/admin/privilege/edit.html" class="form-horizontal" id="form1" method="post"  >
					
							
			<div class="form-group">
				<label class="col-sm-3 control-label">权限名字</label>
				<div class="col-sm-8">
					<input placeholder=""   name="name" class="form-control  " type="text" value="用户管理5"  >
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input placeholder=""   name="ico" class="form-control  " type="text" value="fa-edit"  >
					<span class="help-block m-b-none"><i class="fa fa-info-circle"></i><span class="error-tip"></span></span>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea   type="text/plain" style="width:100%;height:150px;" name="remark" >333</textarea>
