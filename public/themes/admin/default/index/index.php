...
<html>
	...
	<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
			...
			<nav class="navbar-default navbar-static-side" role="navigation">
				...
				<div class="sidebar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li>
							<a class="J_menuItem" href="css_animation.html"><i class="fa fa-magic"></i>
						...
						<li>
							...
							<ul class="nav nav-second-level">
								<li>
									<a class="J_menuItem" href="demo_form_basic.html">表单</a>
								</li>
								<li>
									<a class="J_menuItem" href="demo_table_base.html">基本表格</a>
								</li>
								<li>
									<a class="J_menuItem" href="demo_upload_multi_file.html">多文件上传</a>
								</li>
								<li>
									<a class="J_menuItem" href="demo_upload_multi_img.html">多图片上传</a>
								</li>
								<li>
									<a class="J_menuItem" href="demo_upload_singla_file.html">单文件上传</a>
								</li>
								<li>
									<a class="J_menuItem" href="demo_upload_singla_img.html">单图片上传</a>
								</li>

								<!--

																<li>
																	<a class="J_menuItem" href="demo_city_pick.html">联动选地区</a>
																</li>
								-->
			...
			<div class="small-chat-box fadeInRight animated">
				...
				<div class="content">
					...
					<div class="left">
						...
						<div class="chat-message active">
							1.所有源码(未压缩、带注释版本)； <br> 2.说明文档； <br> 3.终身免费升级服务； <br> 4.必要的技术支持； <br> 5.付费二次开发服务；
							<br> 6.授权许可； <br> …… <br>
						</div>
					</div>
				</div>
		...
		<script src="__HPLUS__js/plugins/layer/layer.min.js"></script>

		<script src="__HPLUS__js/hplus.min.js?v=4.1.0"></script>
