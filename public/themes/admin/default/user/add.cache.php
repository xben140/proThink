...
<!-- ! ~~~JS_LIB~~~ -->
	...
	<body   class=" gray-bg" >
		...
		<div class="wrapper wrapper-content animated fadeInRight   ">
			...
			<form action="/admin/user/add.html" class="form-horizontal" id="form1" method="post"  >
					
							
			<div class="form-group">
				<label class="col-sm-3 control-label">用户名</label>
				<div class="col-sm-8">
					<input placeholder="请填写用户名"   name="user" class="form-control  " type="text" value=""  >
...
-->
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input placeholder=""   name="email" class="form-control  " type="text" value=""  >
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<input placeholder=""   name="phone" class="form-control  " type="text" value=""  >
