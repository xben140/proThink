...
<!-- ! ~~~JS_LIB~~~ -->
	...
	<body   class=" gray-bg" >
		...
		<div class="wrapper wrapper-content animated fadeInRight   ">
			...
			<form action="/admin/config/edit.html" class="form-horizontal" id="form1" method="post"  >
			...
			<label class="checkbox-inline i-checks">
				<input name="type" type="radio" value="3"  checked >
				switch
			</label>
			...
			<div class="form-group">
				...
				<div class="col-sm-8">
					<textarea   type="text/plain" style="width:100%;height:150px;" name="value" >1</textarea>
