...
<div class="col-sm-12">
		...
		<td  >
				...
				<span  class="name"  > name222:

 </span>

<span  class="td-modify name"  data-field="name"  data-reg="/^\d{1,4}$/"  data-msg="请填写合法手机号码"  > 234
		...
		<select  data-field="ttt"  class="   td-select" >
			<option value='0' selected>请选择0000</option><option value='1' >请选择111</option><option value='2' >请选择222</option>
		</select>
		...
		<td  >
				...
				<span  class="name"  > time22:

 </span>

<span  class=" name"  > 2018-08-20 10:07:26
...
<!-- ! ~~~BODY~~~ -->
		...
		<div class="col-sm-6 m-b-xs">
				...
				<select class=" form-control  inline change_serach" name="a1">
					<option value='1' >年1</option><option value='2' selected>月1</option><option value='3' >日1</option>
				</select>
			</div>
	...
	<span class="input-group-btn">
		<span class="btn">上传时间2</span>
	</span>
	<div data-toggle="buttons" class="btn-group">
		<!--<label class="btn  btn-white active"> <input type="radio" id="option2" name="options">周</label>-->
		<label class="btn  btn-white "> <input  type="radio"   name="a2" value="1">年2</label><label class="btn  btn-white active"> <input checked type="radio"   name="a2" value="2">月2</label><label class="btn  btn-white "> <input  type="radio"   name="a2" value="3">日2</label>
	</div>
</div>
		...
		<div class="col-sm-12 m-b-xs">
							...
							<div class="input-daterange input-group">
					<span class="input-group-btn">
						<span class="btn">上传时间3</span>
					</span>
					<div data-toggle="buttons" class="btn-group">
						<!--<label class="btn  btn-white active"> <input type="radio" id="option2" name="options">周</label>-->
						<label class="btn  btn-white active"> <input checked type="checkbox"   name="a3" value="1">年3</label><label class="btn  btn-white active"> <input checked type="checkbox"   name="a3" value="2">月3</label><label class="btn  btn-white "> <input  type="checkbox"   name="a3" value="3">日3</label>
					</div>
				</div>
		...
		<div class="col-sm-6 m-b-xs">
			...
			<div class="input-daterange input-group">
	<span class="input-group-btn">
		<span class="btn">用户状态</span>
	</span>
	<div data-toggle="buttons" class="btn-group">
		<!--<label class="btn  btn-white active"> <input type="radio" id="option2" name="options">周</label>-->
		<label class="btn  btn-white active"> <input checked type="radio"   name="c1" value="1">年4</label><label class="btn  btn-white "> <input  type="radio"   name="c1" value="2">月4</label><label class="btn  btn-white "> <input  type="radio"   name="c1" value="3">日4</label>
	</div>
</div>
				...
				<div class="input-daterange input-group">
					...
					<div data-toggle="buttons" class="btn-group">
						<!--<label class="btn  btn-white active"> <input type="radio" id="option2" name="options">周</label>-->
						<label class="btn  btn-white active"> <input checked type="checkbox"   name="c2" value="1">年5</label><label class="btn  btn-white active"> <input checked type="checkbox"   name="c2" value="2">月5</label><label class="btn  btn-white "> <input  type="checkbox"   name="c2" value="3">日5</label>
					</div>
				</div>
		...
		<div class="input-group">
			...
			<input type="text" placeholder="随便写" class=" form-control" value="gaag" name="d1">
		</div>
		...
		<div class="col-sm-12 m-b-xs">
			...
			<div class="input-group">
				...
				<input type="text" placeholder="placeholder1" class=" form-control" name="e1" value="名字" >
				<span class="input-group-btn"><span class="btn">到</span></span>
				<input type="text" placeholder="placeholder2" class=" form-control" name="e2" value="value2" >
			</div>
		...
		<div class="col-sm-12 m-b-xs">
				...
				<div class="input-daterange input-group">
					...
					<input type="text" placeholder="placeholder1" class=" form-control" name="f1" value="名字" >
						<span class="input-group-addon">到</span>
					<input type="text" placeholder="placeholder2" class=" form-control" name="f2" value="value2" >
				</div>
