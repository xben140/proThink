...
<link rel="stylesheet" href="__PLUGINS__webuploader/examples/single-file-upload/style.css">
...
<!-- ! ~~~JS_LIB~~~ -->
	...
	<body   data-id="5"  style="overflow:hidden"  class=" gray-bg" >
...
<div class="col-sm-12">
			...
			<form action="/home/index/api.html" class="form-horizontal" id="form1" method="post"  data-id="5"  data-pid="6"  >
...
<!--
									...
									<div class="uploader-preview">
										<img src="http://local15.cc/static/image/timg.jpg" alt="">
									</div>
-->
...
<script src="__PLUGINS__webuploader/examples/single-file-upload/upload.js"></script>
