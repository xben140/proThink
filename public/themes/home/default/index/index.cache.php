...
<!-- ! ~~~JS_LIB~~~ -->
	...
	<body   style="overflow:hidden"  class="fixed-sidebar full-height-layout gray-bg"  data-id="5"  data-pid="6" >
...
-->
	...
	<div id="page-wrapper" class="gray-bg dashbard-1">
		...
		<div class="row J_mainContent" id="content-main">
			<iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="http://baidu.com" frameborder="0" data-id="index_v1.html" seamless></iframe>
		</div>
		
		<div class="footer">
			<div class="pull-right">&copy; 2014-2015
				<a href="#" target="_blank">zihan's blog</a>
			</div>
		</div>
