...
<span  class="td-modify name"  data-field="name"  data-reg="/^\d{1,4}$/"  data-msg="请填写合法手机号码"  > 234
		...
		<select  data-field="time111:"  class="   td-select" >
			<option value='1' selected>年</option><option value='2' >月</option><option value='3' >日</option>
		</select>
...
<span  class=" name"  > 2018-08-20 10:16:51
...
<!-- ! ~~~BODY~~~ -->
	...
	<span class="input-group-btn">
		<span class="btn">searchFormRadio</span>
	</span>
	<div data-toggle="buttons" class="btn-group">
		<!--<label class="btn  btn-white active"> <input type="radio" id="option2" name="options">周</label>-->
		<label class="btn  btn-white "> <input  type="radio"   name="nameaaa" value="1">年</label><label class="btn  btn-white "> <input  type="radio"   name="nameaaa" value="2">月</label><label class="btn  btn-white active"> <input checked type="radio"   name="nameaaa" value="3">日</label>
	</div>
</div>
		...
		<div class="col-sm-6 m-b-xs">
							...
							<div class="input-daterange input-group">
					<span class="input-group-btn">
						<span class="btn">searchFormCheckbox</span>
					</span>
					<div data-toggle="buttons" class="btn-group">
						<!--<label class="btn  btn-white active"> <input type="radio" id="option2" name="options">周</label>-->
						<label class="btn  btn-white active"> <input checked type="checkbox"   name="namebbbb" value="1">年</label><label class="btn  btn-white active"> <input checked type="checkbox"   name="namebbbb" value="2">月</label><label class="btn  btn-white "> <input  type="checkbox"   name="namebbbb" value="3">日</label>
					</div>
				</div>
