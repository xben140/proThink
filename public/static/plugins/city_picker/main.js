function SelCity(obj, e)
{
	...
	$("#cColse").click(function () {Iput.colse();});
	var tb_province = [];
	var b = province;
	...
	$("#_citys0 a").click(function () {
		...
		{
			var hcitys = $('<input>', {type: 'hidden', name: "hcity", "data-id": $(this).data("id"), id: "hcity", val: lev});
			$(ths).after(hcitys);
		}
		else
		{
		...
		$("#_citys1 a").click(function () {
			...
			{
				var hcitys = $('<input>', {type: 'hidden', name: "hproper", "data-id": $(this).data("id"), id: "hproper", val: lev});
				$(ths).after(hcitys);
			}
			else
			{
			...
			$("#_citys2 a").click(function () {
				...
				{
					var hcitys = $('<input>', {type: 'hidden', name: "harea", "data-id": $(this).data("id"), id: "harea", val: lev});
					$(ths).after(hcitys);
				}
				else
				{
